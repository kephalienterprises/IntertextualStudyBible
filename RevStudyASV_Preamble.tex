...
%to get frontmatter and backmatter chapters to appear in italics in toc
\renewcommand*{\cftchapterfont}{\itshape\bfseries}
...
\fancyhead[RO, LE]{\thechapter} %for even pages, put the chapter title on left side; for odd pages, put on right
...
\makeindex[title=Scripture Index,name=scr,options=-s index_style.ist,intoc]
