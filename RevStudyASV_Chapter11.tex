...
\vleftofline{\vnum{18} \ }And the nations were wroth,\\*\vin and thy wrath came,\\*\vin and the time of the dead to be judged,\\ and the time to give their reward to thy servants the prophets,\\*\vin and to the saints, and to them that fear thy name,\\*\vin the small and the great;\\ and to destroy them that destroy the earth.
\end{verse}
